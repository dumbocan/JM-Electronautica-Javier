...
class DetailController extends worksheetController
{
    ...
    public function ask_delete_detail()
    {
        ...
        $project_id = $_POST['project_id'];
        require_once 'views/detail/detail_delete.php';
    }
    ...
    public function delete_detail()
    {
        ...
        require_once 'views/detail/detail_ok.php';
        //header('location:'.base_url.'worksheet/prepare_worksheet');
    }
}
